...
class SubscribeTriggerFormDialog extends StatefulWidget {
  const SubscribeTriggerFormDialog({super.key});

  @override
  State<SubscribeTriggerFormDialog> createState() => _SubscribeTriggerFormDialogState();
}

class _SubscribeTriggerFormDialogState extends State<SubscribeTriggerFormDialog> {
